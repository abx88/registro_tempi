...
# Genera una nuova chiave (key) dinamica per il text_input
input_text_key = 'stringa_lav_input' + str(st.session_state.contatore)
input_lavorazione = st.text_input("stringa lavorazione", key=input_text_key, value=st.session_state.stringa_lav)
